...
<div role="group" class="col-md-6">
  <b-carousel
    ...
    img-height="300"
  >
    <b-carousel-slide caption="Карта на град Пловдив"  img-src="static/images/карта-на-град_пловдив.jpg" class="img-thumbnail" alt="Center image" />
  ...
  <b-embed
    type="iframe"
    aspect="16by9"
    <iframe width="825" height="40" src="https://www.youtube.com/embed/xD-qXkCJ9aw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
